// src/components/layout/Header.tsx - FIXED: Proper dark theme implementation
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button
                            ...
                            className="lg:hidden btn btn-secondary btn-sm hover:scale-105 transition-transform duration-200"
                    ...
                    {/* Right Section */}
                    <div className="flex items-center space-x-3">
                        {/* Application Stats - Hidden on mobile */}
                        <div className="hidden md:flex items-center space-x-4 text-sm text-gray-600 dark:text-gray-400">
                            <div className="flex items-center space-x-1">
                                <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
                                <span>{useAppStore.getState().applications.length} Apps</span>
                            </div>
                            <div className="flex items-center space-x-1">
                                <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                                <span>{useAppStore.getState().filteredApplications.length} Shown</span>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className="theme-toggle glass rounded-xl p-3 hover:scale-110 transition-all duration-300 group relative"
                        ...
                        {/* User Profile/Settings - Future enhancement */}
