          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50 text-lg px-6 py-4 rounded-lg font-semibold transition-all duration-200"
              >
                Import Data
              </button>
              <button
                onClick={handleStartTour}
                className="border-2 border-green-600 text-green-600 hover:bg-green-50 text-lg px-6 py-4 rounded-lg font-semibold transition-all duration-200"
              >
                Take Tour
              </button>
            </div>
