...
const FeaturesPricingTab: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-6">
                ...
                <div className="glass-card bg-white/60 dark:bg-gray-800/60 rounded-xl p-6 max-w-4xl mx-auto">
...
export default FeaturesPricingTab;