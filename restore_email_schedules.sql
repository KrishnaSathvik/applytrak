-- ============================================================================
-- RESTORE EMAIL SCHEDULES AND FUNCTIONS
-- ============================================================================
-- Run this AFTER your clean database schema to restore email functionality
-- This recreates all the email schedule functions and cron jobs
...
-- Create a function to send inactivity reminder emails
...
BEGIN
    ...
    FOR user_record IN 
        SELECT u.id, u.email, u.display_name, u.externalid, u.updatedat
        FROM users u
        JOIN email_preferences ep ON u.id = ep.userid
    ...
    LOOP
        ...
        days_inactive := EXTRACT(DAYS FROM (NOW() - user_record.updatedat));
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE 'EMAIL SCHEDULES RESTORED SUCCESSFULLY!';
    RAISE NOTICE '========================================';
    RAISE NOTICE 'All email functions and cron jobs have been recreated.';
    RAISE NOTICE 'Weekly goals: Every Sunday at 9 AM UTC';
    RAISE NOTICE 'Weekly tips: Every Wednesday at 10 AM UTC';
    RAISE NOTICE 'Monthly analytics: 1st of every month at 8 AM UTC';
    RAISE NOTICE 'Inactivity reminders: Daily at 11 AM UTC';
    RAISE NOTICE 'Milestone checks: Daily at 12 PM UTC';
    RAISE NOTICE 'All Edge Functions are still working!';
    RAISE NOTICE '========================================';
END $$;
