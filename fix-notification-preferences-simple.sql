-- Simple fix for notification_preferences without triggers
...
-- 7. Create a simple upsert function without triggers
...
DECLARE
    result json;
BEGIN
    -- Upsert notification preferences with explicit updated_at
...
-- 8. Grant permissions for the upsert function
...
-- 9. Test the function
SELECT 'Simple notification preferences setup completed' as status;
